<script>
	...
	const infoTextTop = `"Firm culture defines how you and your team relate to one another. It is also defined by how you treat your clients."`;

	const firstCardContent = {
		imgUrl	: '/TylerNunnally.jpg', 
		imgAlt: 'Tyler D. Nunnally',
		text: ``,
		header: '',
	...
	const secondCardContent = {
		...
		text: 'My career path took some interesting twists and turns before I joined the wealth management industry and eventually moved into M&A. I did not start-out as an analyst at an investment bank or work for a Wall Street firm.',
		header: 'OUR APPROACH',
	...
	const bulletPointContent = {
		...
		points: [
			{
				img: '/learn-more-global.svg',
				imgAlt: 'the earth over the palm of a hand',
				header: 'Perspective',
				text: ['Investment advisory is a people business. RIAs are relatively small, and you have to work closely with the people around you. Firm culture defines how you and your team relate to one another. It is also defined by how you treat your clients.', 'Nunnally International puts a great deal of emphasis on compatible firm cultures because it is often the difference between a successful M&A partnership and one that fails.']
			},
			{
				img: '/learn-more-shield.svg',
				imgAlt: 'a shield with a checkmark coat of arms',
				header: 'Transparency',
				text: ['The payoff for M&A deals is very rewarding and so the incentives are strong for M&A advisors, as well as buyers and sellers. The desire to win can often bring-out the worst in people. Broken promises, half-truths and flat-out lies - whatever it takes.', 'You have to choose your partners wisely which requires rigorous due diligence. We are firm believers in the Reagan era Cold War adage: Trust, but verify.']
			},
			{
				img: '/learn-more-heart.svg',
				imgAlt: 'a heart lamp',
				header: 'Perseverance',
				text: ['The M&A process can be long and tedious. It can be emotionally draining and takes internal fortitude, a strong will to succeed and the ability to adapt.', 'We advise clients to be mentally prepared from the onset of talks and stick with the process despite the inevitable turmoil along the way. You have to persevere in order to achieve your objectives and never lose sight of the ultimate goal.']
			},
		],
		background: 'background: #D6DDD9;',
